...
export async function crawlSite(startUrl, opts = {}) {
  ...
  // 4. Generador de llms.txt sugerido (Bloque B)
 ...
 * Detecta URLs con parámetros que pueden causar duplicados (utm, sessionid, etc.)
 */
...
function aggregate(pages, origin) {
  ...
  // ─── NUEVO: Bloque C — Capa 1 completa ───────────────────────────────────
  // Tamaños y redirects
  ...
  // ─── NUEVO: Bloque A — AEO Citability promedio ───────────────────────────
